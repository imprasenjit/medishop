...
<aside class="main-sidebar">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <!-- Invoice menu end -->
            <!-- Product menu start -->
            <li class="treeview <?php if ($this->uri->segment('1') == ("Cproduct") || $this->uri->segment('1') == ("Cqrcode") || $this->uri->segment('1') == ("Cbarcode")) {
                                    echo "active";
                                } else {
                                    echo " ";
                                } ?>">
            ...
            if ($this->session->userdata('user_type') == '1') {
                ?>
                <!-- Accounts menu start -->
                <li class="treeview <?php if ($this->uri->segment('1') == ("Caccounts") || $this->uri->segment('2') == ("table_create") || $this->uri->segment('2') == ("table_list") || $this->uri->segment('2') == ("table_edit")) {
                                        echo "active";
                                    } else {
                                        echo " ";
                                    } ?>">
