			...
			<div class="col-sm-12">
		        <div class="panel panel-default">
		            <div class="panel-body"> 
						<?php echo form_open('Csearch/customer_search',array('class' => 'form-inline', ));?>
			                    ...
			                    <table class="table table-bordered table-striped table-hover medicine_search">
									...
									?>
										...
										<tr>
											...
											<td align="center">
											<a href="<?php echo base_url('Ccustomer/customerledger/{customer_id}');?>" target="_blank"><button class="btn btn-success"><?php echo display('details')?></button>
											</a>
											</td>
										</tr>
										{/search_result}
