			...
			<div class="col-sm-12">
		        <div class="panel panel-default">
		            <div class="panel-body"> 
						<?php echo form_open('Csearch/medicine_search',array('class' => 'form-inline', ));?>
			                    ...
			                    <table class="table table-bordered table-striped table-hover medicine_search">
									...
									?>
										...
										<tr>
											...
											<td>{total_stock}</td>
											<td align="center">
											<a href="<?php echo base_url('Cproduct/product_details/{product_id}');?>" target="_blank"><button class="btn btn-success"><?php echo display('details')?></button>
											</a>
											</td>
										</tr>
										{/search_result}
